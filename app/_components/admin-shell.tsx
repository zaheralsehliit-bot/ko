...
const links = [["/portal/admin", "نظرة عامة"], ["/dashboard/today", "جدول اليوم"], ["/members", "المتدربون"], ["/coaches", "الكباتن والموظفون"], ["/dashboard/courses", "الدورات"], ["/schedule", "المواعيد والحجوزات"], ["/schedule/online", "مواعيد الأونلاين"], ["/finance", "الحسابات والفواتير"], ["/store", "المتجر والمخزون"], ["/reports", "تقارير المستثمر"], ["/users", "المستخدمون"]] as const;
