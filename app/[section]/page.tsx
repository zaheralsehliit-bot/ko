...
export default function DetailPage() {
  ...
  return <main dir="rtl" className="app-shell detail-shell">
    <aside className="sidebar">
      <Link className="brand" href="/"><span className="brand-mark">KO</span><span>KO Fighters<span className="brand-dot">.</span></span></Link>
